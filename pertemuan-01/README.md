1. Konsep Dasar Pemrograman Web
   Saya mempelajari dasar-dasar pemrograman web dan cara kerja sebuah website. <br>
...
5. Hubungan Antarteknologi
   Saya memahami bahwa HTML, CSS, JavaScript, PHP, dan MySQL saling berhubungan untuk membuat website yang dapat digunakan dan memiliki fitur dinamis. <br>

Kesimpulan:
Dari pembelajaran P1, saya jadi lebih memahami dasar-dasar pemrograman web dan cara kerja teknologi yang digunakan untuk membuat sebuah website. <br>